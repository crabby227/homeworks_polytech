...
int main() {
    ...
    nechet_devisorsA=1, chet_devisorsB=0, sum_devisors2, mutual_devisor;
    ...
    cout << "3. Сумма произведения нечетных делителей A на сумму четных делителей В = " << sum_devisors2 << endl;
